  ...
  return (
    <>
      ...
      <div className="mt-14 flex flex-wrap justify-center gap-4">
        <a
          href="https://github.com/tajsharma"
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-2.5 px-5 py-2.5 rounded-full border-2 border-border bg-surface font-mono text-[13px] text-text-secondary hover:border-accent hover:text-accent transition-colors"
        >
        ...
        <a
          href="https://www.linkedin.com/in/tajsharma5/"
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-2.5 px-5 py-2.5 rounded-full border-2 border-border bg-surface font-mono text-[13px] text-text-secondary hover:border-accent hover:text-accent transition-colors"
        >
